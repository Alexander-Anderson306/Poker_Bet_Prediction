...
def train_random_forest_classifier(X_train, X_test, y_train, y_test, num_trees):
    model = RandomForestClassifier(n_estimators=num_trees,random_state=67).fit(X_train, y_train)
    return model.score(X_test, y_test)
